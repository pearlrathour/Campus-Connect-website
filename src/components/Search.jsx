...
import supportImg from '../assets/Oakroot.jpg'

const Search = () => {
  return (
  <div name='search' className='w-full mt-24'>
      ...
      <div className='max-w-[1240px] mx-auto text-white relative'>
          <div className='px-4 py-12'>
              <h2 className='text-3xl pt-8 text-slate-300 uppercase text-center'>Search</h2>
